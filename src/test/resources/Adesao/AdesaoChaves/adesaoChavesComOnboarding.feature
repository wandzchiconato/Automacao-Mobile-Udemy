Feature: Adesão de Chaves Exibindo Onboarding
  ...
  Scenario: Adesao de Chaves Pix CPF validando Onboarding e compartilhando o Comprovante
    ...
    And É exibido a primeira tela de Onboarding
  ...
  Scenario: Adesao de Chaves Pix Celular validando Onboarding e o botão Copiar Chave Pix
    Given Que o Usuario está na Home do App
    When seleciona a Opção Minhas Chaves
    And É exibido a primeira tela de Onboarding
    And Efetua um Swipe para a esquerda para exibir a segunda tela de Onboarding
    ...
    And Seleciona o CheckBox de Acordo com os termos
    And Seleciona o Botão CONFIRMAR
    And Informa o Código de Validação de Posse recebido
    Then Seleciona a Opção COPIAR CHAVE PIX

  Scenario: Adesao de Chaves Pix E-mail validando Onboarding e o botão Cadastrar Chave
    Given Que o Usuario está na Home do App
    When seleciona a Opção Minhas Chaves
    And É exibido a primeira tela de Onboarding
    And Efetua um Swipe para a esquerda para exibir a segunda tela de Onboarding
  ...
  Scenario: Adesao de Chaves Pix Aleatória validando Onboarding e o botão Compartilhar
    Given Que o Usuario está na Home do App
    When seleciona a Opção Minhas Chaves
    And É exibido a primeira tela de Onboarding
    And Efetua um Swipe para a esquerda para exibir a segunda tela de Onboarding
